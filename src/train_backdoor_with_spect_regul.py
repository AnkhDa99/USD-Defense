...
parser.add_argument('--epoch',      type = int, default = 30, help='the numbe of epoch for training')
...
def main(transform_train, transform_test):
    ...
    ## Initialize changeFIM
    from GradientRegularizer import GradientRegularizer

    criterion_reg = GradientRegularizer(net, criterion, alpha=args.reg_F)
