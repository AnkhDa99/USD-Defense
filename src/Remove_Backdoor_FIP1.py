...
if __name__ == '__main__':
    ...
    parser.add_argument('--poison-type', type=str, default='badnets',
                        choices=['badnets', 'Feature', 'FC', 'SIG', 'Dynamic', 'TrojanNet', 'blend', 'CLB', 'benign'],
    ...
    parser.add_argument('--si_c', type=float, default=0.1, help='SI retention strength when integrating SI into FIP')
    parser.add_argument('--si_epsilon', type=float, default=1e-3, help='SI denominator epsilon')
    parser.add_argument('--si_update_gap', type=int, default=5, help='Consolidate SI omega every k iterations')
